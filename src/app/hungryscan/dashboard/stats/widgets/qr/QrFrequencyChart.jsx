...
export const QrFrequencyChart = () => {
    ...
    const Tooltip = ({datum}) => {
        ...
        return (
            <TooltipContainer>
                <div>
                    <span style={{fontWeight: '500'}}>{datum.data?.label}</span>
                    <br/>
                    <span>
                        {t('percent')}: {percent}%
                    </span>
                    <br/>
                    <span>
                        {capitalizeFirst(t('scans'))}: {datum.data?.value}
                    </span>
                </div>
            </TooltipContainer>
        );
